...
|---|---|---|
| `ts/` | @voxgig-sdk/mock-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mock-sdk \
      --repository voxgig-sdk/mock-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mock-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mock-sdk --id=<id>` removes it.
