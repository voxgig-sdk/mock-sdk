...
from projectname_sdk import MockSDK
from projectname_sdk.core.spec import MockSpec
from projectname_sdk.core.result import MockResult
from projectname_sdk.core.response import MockResponse
from projectname_sdk.core.operation import MockOperation
from projectname_sdk.core.error import MockError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MockBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MockSDK.test(None, None)
        ...
        class TestInitFeature(MockBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MockBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MockSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MockSDK.test(None, setup_opts)
