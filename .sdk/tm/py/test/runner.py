...
class MockTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MockTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MockTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MockTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
