...
class MockTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MockTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MockTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MockTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
