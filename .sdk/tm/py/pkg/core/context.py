...
from projectname_sdk.core.control import MockControl
...
class MockContext:
    ...
    def make_error(self, code, msg):
        return MockError(code, msg, self)
