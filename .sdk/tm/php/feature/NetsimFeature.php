...
class MockNetsimFeature extends MockBaseFeature
{
    ...
    private function _simulate(MockContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MockContext $ctx, array $applied): void
    {
        $client = $this->client;
