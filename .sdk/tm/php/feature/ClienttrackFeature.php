...
class MockClienttrackFeature extends MockBaseFeature
{
    ...
    public function PostConstruct(MockContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Mock-SDK';
