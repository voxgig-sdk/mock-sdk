...
class MockCacheFeature extends MockBaseFeature
{
    ...
    private function _through(MockContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
