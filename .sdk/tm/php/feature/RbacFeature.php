...
class MockRbacFeature extends MockBaseFeature
{
    ...
    private function _required(MockContext $ctx): ?string
    {
    ...
    private function _reject(MockContext $ctx, string $required): void
    {
    ...
    private function _track(MockContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
