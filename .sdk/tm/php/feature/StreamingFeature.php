...
class MockStreamingFeature extends MockBaseFeature
{
    ...
    private function _iterate(MockResult $result): \Generator
    {
    ...
    private function _streamable(MockContext $ctx): bool
    {
