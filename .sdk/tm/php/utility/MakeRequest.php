...
// Mock SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MockMakeRequest
{
    public static function call(MockContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MockResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MockResponse($fetched);
        } else {
