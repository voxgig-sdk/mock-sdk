...
describe("CouponDirect", function()
  it("should direct-list-coupon", function()
    local setup = coupon_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-coupon", setup.live and "live" or "unit")
...
function coupon_direct_setup(mockres)
