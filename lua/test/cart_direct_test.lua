...
describe("CartDirect", function()
  it("should direct-list-cart", function()
    local setup = cart_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cart", setup.live and "live" or "unit")
...
function cart_direct_setup(mockres)
