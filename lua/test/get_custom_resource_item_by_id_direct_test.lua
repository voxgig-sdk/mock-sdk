-- GetCustomResourceItemById direct test
...
describe("GetCustomResourceItemByIdDirect", function()
  it("should direct-load-get_custom_resource_item_by_id", function()
    local setup = get_custom_resource_item_by_id_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_custom_resource_item_by_id", setup.live and "live" or "unit")
...
function get_custom_resource_item_by_id_direct_setup(mockres)
