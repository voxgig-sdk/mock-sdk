-- Mock SDK GetCustomResourceItemById entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local GetCustomResourceItemByIdEntity = {}
GetCustomResourceItemByIdEntity.__index = GetCustomResourceItemByIdEntity


function GetCustomResourceItemByIdEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCustomResourceItemByIdEntity)
  self._name = "get_custom_resource_item_by_id"
  self._client = client
...
function GetCustomResourceItemByIdEntity:get_name()
  return self._name
end


function GetCustomResourceItemByIdEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCustomResourceItemByIdEntity.new(self._client, opts)
end
...
function GetCustomResourceItemByIdEntity:mark_deleted()
  self._deleted = true
end


function GetCustomResourceItemByIdEntity:deleted()
  return true == self._deleted
end


function GetCustomResourceItemByIdEntity:data_set(args)
  if args ~= nil then
...
function GetCustomResourceItemByIdEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCustomResourceItemByIdEntity:match_set(args)
  if args ~= nil then
...
function GetCustomResourceItemByIdEntity:match_get()
...
function GetCustomResourceItemByIdEntity:stream(action, args, callopts)
...
---@param reqmatch GetCustomResourceItemByIdLoadMatch
---@param ctrl? table
---@return GetCustomResourceItemById
---@return string? err
function GetCustomResourceItemByIdEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetCustomResourceItemByIdEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetCustomResourceItemByIdEntity
