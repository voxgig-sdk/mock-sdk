...
local CreateCustomResourceItemEntity = {}
CreateCustomResourceItemEntity.__index = CreateCustomResourceItemEntity


function CreateCustomResourceItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateCustomResourceItemEntity)
  self._name = "create_custom_resource_item"
  self._client = client
...
function CreateCustomResourceItemEntity:get_name()
  return self._name
end


function CreateCustomResourceItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateCustomResourceItemEntity.new(self._client, opts)
end
...
function CreateCustomResourceItemEntity:mark_deleted()
  self._deleted = true
end


function CreateCustomResourceItemEntity:deleted()
  return true == self._deleted
end


function CreateCustomResourceItemEntity:data_set(args)
  if args ~= nil then
...
function CreateCustomResourceItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateCustomResourceItemEntity:match_set(args)
  if args ~= nil then
...
function CreateCustomResourceItemEntity:match_get()
...
function CreateCustomResourceItemEntity:stream(action, args, callopts)
...
---@param reqdata CreateCustomResourceItemCreateData
---@param ctrl? table
---@return CreateCustomResourceItem
---@return string? err
function CreateCustomResourceItemEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateCustomResourceItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateCustomResourceItemEntity
