...
local PatchCustomResourceItemEntity = {}
PatchCustomResourceItemEntity.__index = PatchCustomResourceItemEntity


function PatchCustomResourceItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PatchCustomResourceItemEntity)
  self._name = "patch_custom_resource_item"
  self._client = client
...
function PatchCustomResourceItemEntity:get_name()
  return self._name
end


function PatchCustomResourceItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PatchCustomResourceItemEntity.new(self._client, opts)
end
...
function PatchCustomResourceItemEntity:mark_deleted()
  self._deleted = true
end


function PatchCustomResourceItemEntity:deleted()
  return true == self._deleted
end


function PatchCustomResourceItemEntity:data_set(args)
  if args ~= nil then
...
function PatchCustomResourceItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PatchCustomResourceItemEntity:match_set(args)
  if args ~= nil then
...
function PatchCustomResourceItemEntity:match_get()
...
function PatchCustomResourceItemEntity:stream(action, args, callopts)
...
function PatchCustomResourceItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PatchCustomResourceItemEntity
