...
local GetCustomResourceEntity = {}
GetCustomResourceEntity.__index = GetCustomResourceEntity


function GetCustomResourceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCustomResourceEntity)
  self._name = "get_custom_resource"
  self._client = client
...
function GetCustomResourceEntity:get_name()
  return self._name
end


function GetCustomResourceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCustomResourceEntity.new(self._client, opts)
end
...
function GetCustomResourceEntity:mark_deleted()
  self._deleted = true
end


function GetCustomResourceEntity:deleted()
  return true == self._deleted
end


function GetCustomResourceEntity:data_set(args)
  if args ~= nil then
...
function GetCustomResourceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCustomResourceEntity:match_set(args)
  if args ~= nil then
...
function GetCustomResourceEntity:match_get()
...
function GetCustomResourceEntity:stream(action, args, callopts)
...
function GetCustomResourceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetCustomResourceEntity
