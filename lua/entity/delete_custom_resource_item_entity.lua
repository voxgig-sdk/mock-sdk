...
local DeleteCustomResourceItemEntity = {}
DeleteCustomResourceItemEntity.__index = DeleteCustomResourceItemEntity


function DeleteCustomResourceItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeleteCustomResourceItemEntity)
  self._name = "delete_custom_resource_item"
  self._client = client
...
function DeleteCustomResourceItemEntity:get_name()
  return self._name
end


function DeleteCustomResourceItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeleteCustomResourceItemEntity.new(self._client, opts)
end
...
function DeleteCustomResourceItemEntity:mark_deleted()
  self._deleted = true
end


function DeleteCustomResourceItemEntity:deleted()
  return true == self._deleted
end


function DeleteCustomResourceItemEntity:data_set(args)
  if args ~= nil then
...
function DeleteCustomResourceItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeleteCustomResourceItemEntity:match_set(args)
  if args ~= nil then
...
function DeleteCustomResourceItemEntity:match_get()
...
function DeleteCustomResourceItemEntity:stream(action, args, callopts)
...
function DeleteCustomResourceItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeleteCustomResourceItemEntity
