-- Mock SDK UpdateCustomResourceItem entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UpdateCustomResourceItemEntity = {}
UpdateCustomResourceItemEntity.__index = UpdateCustomResourceItemEntity


function UpdateCustomResourceItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateCustomResourceItemEntity)
  self._name = "update_custom_resource_item"
  self._client = client
...
function UpdateCustomResourceItemEntity:get_name()
  return self._name
end


function UpdateCustomResourceItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UpdateCustomResourceItemEntity.new(self._client, opts)
end
...
function UpdateCustomResourceItemEntity:mark_deleted()
  self._deleted = true
end


function UpdateCustomResourceItemEntity:deleted()
  return true == self._deleted
end


function UpdateCustomResourceItemEntity:data_set(args)
  if args ~= nil then
...
function UpdateCustomResourceItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateCustomResourceItemEntity:match_set(args)
  if args ~= nil then
...
function UpdateCustomResourceItemEntity:match_get()
...
function UpdateCustomResourceItemEntity:stream(action, args, callopts)
...
---@param reqdata UpdateCustomResourceItemUpdateData
---@param ctrl? table
---@return UpdateCustomResourceItem
---@return string? err
function UpdateCustomResourceItemEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function UpdateCustomResourceItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UpdateCustomResourceItemEntity
