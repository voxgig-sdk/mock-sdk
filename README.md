...
This SDK exposes the API as a small set of **semantic entities** — Cart, Coupon, CreateCustomResourceItem, DeleteCustomResourceItem, GetCustomResource, GetCustomResourceItemById, PatchCustomResourceItem, Product, Status, UpdateCustomResourceItem and User — that you
