...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/mock` | `npm install @voxgig-sdk/mock` |
| Python | `voxgig-sdk-mock` | `pip install voxgig-sdk-mock` |
| PHP | `voxgig-sdk/mock` | `composer require voxgig-sdk/mock` |
| Golang | `github.com/voxgig-sdk/mock-sdk/go` | `go get github.com/voxgig-sdk/mock-sdk/go` |
| Ruby | `voxgig-sdk-mock` | `gem install voxgig-sdk-mock` |
| Lua | `voxgig-sdk-mock` | `luarocks install voxgig-sdk-mock` |
