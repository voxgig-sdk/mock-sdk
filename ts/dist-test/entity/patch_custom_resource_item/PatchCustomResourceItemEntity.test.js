...
(0, node_test_1.describe)('PatchCustomResourceItemEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'patch_custom_resource_item.' + op, live))
                return;
        }
        ...
        let patch_custom_resource_item_ref01_data = Object.values(setup.data.existing.patch_custom_resource_item)[0];
        // UPDATE
        const patch_custom_resource_item_ref01_ent = client.PatchCustomResourceItem();
        const patch_custom_resource_item_ref01_data_up0 = {};
        ...
        (0, node_assert_1.default)(patch_custom_resource_item_ref01_resdata_up0.id === patch_custom_resource_item_ref01_data_up0.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/patch_custom_resource_item/PatchCustomResourceItemTestData.json');
    ...
    let idmap = transform(['patch_custom_resource_item01', 'patch_custom_resource_item02', 'patch_custom_resource_item03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MOCK_TEST_PATCH_CUSTOM_RESOURCE_ITEM_ENTID'];
...
//# sourceMappingURL=PatchCustomResourceItemEntity.test.js.map