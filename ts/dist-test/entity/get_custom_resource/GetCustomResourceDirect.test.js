...
(0, node_test_1.describe)('GetCustomResourceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_custom_resource', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_custom_resource', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["get_custom_resource01"]))
            return;
...
function liveScenariosActive() { return false && process.env.MOCK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MockSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MOCK_TEST_GET_CUSTOM_RESOURCE_ENTID'];
...
//# sourceMappingURL=GetCustomResourceDirect.test.js.map