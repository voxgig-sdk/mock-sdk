...
(0, node_test_1.describe)('GetCustomResourceItemByIdDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_custom_resource_item_by_id', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_custom_resource_item_by_id', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["id01", "resource01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MOCK_TEST_GET_CUSTOM_RESOURCE_ITEM_BY_ID_ENTID'];
...
//# sourceMappingURL=GetCustomResourceItemByIdDirect.test.js.map