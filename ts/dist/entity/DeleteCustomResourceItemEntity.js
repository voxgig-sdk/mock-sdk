...
exports.DeleteCustomResourceItemEntity = void 0;
const MockEntityBase_1 = require("../MockEntityBase");
// TODO: needs Entity superclass
class DeleteCustomResourceItemEntity extends MockEntityBase_1.MockEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'delete_custom_resource_item';
        this.name_ = 'delete_custom_resource_item';
        this.Name = 'DeleteCustomResourceItem';
    }
    make() {
        return new DeleteCustomResourceItemEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DeleteCustomResourceItemEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DeleteCustomResourceItemEntity = DeleteCustomResourceItemEntity;
//# sourceMappingURL=DeleteCustomResourceItemEntity.js.map