...
class PatchCustomResourceItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PatchCustomResourceItemEntity(self._client, opts)
    ...
    def data_get(self) -> PatchCustomResourceItem:
    ...
    def match_get(self) -> PatchCustomResourceItem:
    ...
    def update(self, reqdata: PatchCustomResourceItemUpdateData, ctrl=None) -> PatchCustomResourceItem:
        utility = self._utility
