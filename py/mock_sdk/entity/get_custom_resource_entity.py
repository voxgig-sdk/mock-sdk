...
class GetCustomResourceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetCustomResourceEntity(self._client, opts)
    ...
    def data_get(self) -> GetCustomResource:
    ...
    def match_get(self) -> GetCustomResource:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetCustomResource]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetCustomResource().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
