...
class UpdateCustomResourceItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpdateCustomResourceItemEntity(self._client, opts)
    ...
    def data_get(self) -> UpdateCustomResourceItem:
    ...
    def match_get(self) -> UpdateCustomResourceItem:
    ...
    def update(self, reqdata: UpdateCustomResourceItemUpdateData, ctrl=None) -> UpdateCustomResourceItem:
        utility = self._utility
