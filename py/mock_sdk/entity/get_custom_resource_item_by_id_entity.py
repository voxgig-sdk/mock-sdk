...
class GetCustomResourceItemByIdEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetCustomResourceItemByIdEntity(self._client, opts)
    ...
    def data_get(self) -> GetCustomResourceItemById:
    ...
    def match_get(self) -> GetCustomResourceItemById:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetCustomResourceItemById:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetCustomResourceItemById().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
