...
from mock_sdk.utility import register

# Load features
from mock_sdk.feature.base_feature import MockBaseFeature
from mock_sdk.features import _has_feature, _make_feature
...
class MockSDK:
    ...
    def __init__(self, options=None):
        ...
        from mock_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "MockSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MockSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CreateCustomResourceItem(self, data=None) -> "CreateCustomResourceItemEntity":
        ...
        from mock_sdk.entity.create_custom_resource_item_entity import CreateCustomResourceItemEntity
    ...
    def DeleteCustomResourceItem(self, data=None) -> "DeleteCustomResourceItemEntity":
        ...
        from mock_sdk.entity.delete_custom_resource_item_entity import DeleteCustomResourceItemEntity
    ...
    def GetCustomResource(self, data=None) -> "GetCustomResourceEntity":
        ...
        from mock_sdk.entity.get_custom_resource_entity import GetCustomResourceEntity
    ...
    def GetCustomResourceItemById(self, data=None) -> "GetCustomResourceItemByIdEntity":
        ...
        from mock_sdk.entity.get_custom_resource_item_by_id_entity import GetCustomResourceItemByIdEntity
    ...
    def PatchCustomResourceItem(self, data=None) -> "PatchCustomResourceItemEntity":
        ...
        from mock_sdk.entity.patch_custom_resource_item_entity import PatchCustomResourceItemEntity
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from mock_sdk.entity.product_entity import ProductEntity
    ...
    def Status(self, data=None) -> "StatusEntity":
        ...
        from mock_sdk.entity.status_entity import StatusEntity
    ...
    def UpdateCustomResourceItem(self, data=None) -> "UpdateCustomResourceItemEntity":
        ...
        from mock_sdk.entity.update_custom_resource_item_entity import UpdateCustomResourceItemEntity
    ...
    def User(self, data=None) -> "UserEntity":
        ...
        from mock_sdk.entity.user_entity import UserEntity
