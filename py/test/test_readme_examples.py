# Mock SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MockSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MockSDK(...) and MockSDK.test(...) become
#      MockSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    "Cart": "cart",
    "Coupon": "coupon",
    "CreateCustomResourceItem": "create_custom_resource_item",
    "DeleteCustomResourceItem": "delete_custom_resource_item",
    "GetCustomResource": "get_custom_resource",
    "GetCustomResourceItemById": "get_custom_resource_item_by_id",
    "PatchCustomResourceItem": "patch_custom_resource_item",
    "Product": "product",
    "Status": "status",
    "UpdateCustomResourceItem": "update_custom_resource_item",
    "User": "user",
}
