...
class MockTestRunner
{
    ...
    {
        $live = self::getenv('MOCK_TEST_LIVE');
        $override = self::getenv('MOCK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MOCK_TEST_EXPLAIN');
...
class_alias('MockTestRunner', 'Runner');
class_alias('MockHelpers', 'Helpers');
