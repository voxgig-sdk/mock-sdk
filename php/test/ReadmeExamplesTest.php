...
// Mock SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MockSDK::test)
...
{
    private const SDK_CLASS = 'MockSDK';
    ...
    private const SDK_BASE = 'mock_sdk';
