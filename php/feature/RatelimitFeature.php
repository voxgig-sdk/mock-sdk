...
class MockRatelimitFeature extends MockBaseFeature
{
    ...
    private function _acquire(MockContext $ctx): void
    {
    ...
    private function _track(MockContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
