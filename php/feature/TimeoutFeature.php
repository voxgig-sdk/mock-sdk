...
class MockTimeoutFeature extends MockBaseFeature
{
    ...
    private function _with_timeout(MockContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MockContext $_ctx, float $ms): void
    {
        $client = $this->client;
