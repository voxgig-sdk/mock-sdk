...
class MockProxyFeature extends MockBaseFeature
{
    ...
    public function init(MockContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MockContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
