...
class MockFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MockSDK/1.0)';
    ...
    public static function call(MockContext $ctx, string $fullurl, array $fetchdef): array
    {
