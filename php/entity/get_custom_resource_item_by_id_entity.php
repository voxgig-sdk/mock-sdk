...
class GetCustomResourceItemByIdEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_custom_resource_item_by_id";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetCustomResourceItemByIdEntity($this->_client, $opts);
    }

    /**
     * @param GetCustomResourceItemById|array $args GetCustomResourceItemById data (assoc-array) to store.
     */
    ...
    /**
     * @return GetCustomResourceItemById|array The current GetCustomResourceItemById data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetCustomResourceItemById fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetCustomResourceItemById fields).
     */
    ...
    /**
     * Load a single GetCustomResourceItemById.
     *
     * @param GetCustomResourceItemByIdLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetCustomResourceItemByIdLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetCustomResourceItemById|array The loaded GetCustomResourceItemById as an assoc-array at the
