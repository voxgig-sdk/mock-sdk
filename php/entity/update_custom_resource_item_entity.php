...
class UpdateCustomResourceItemEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "update_custom_resource_item";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UpdateCustomResourceItemEntity($this->_client, $opts);
    }

    /**
     * @param UpdateCustomResourceItem|array $args UpdateCustomResourceItem data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateCustomResourceItem|array The current UpdateCustomResourceItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateCustomResourceItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateCustomResourceItem fields).
     */
     ...
     *
     * @param UpdateCustomResourceItemUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateCustomResourceItemUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateCustomResourceItem|array The updated UpdateCustomResourceItem as an assoc-array at the
