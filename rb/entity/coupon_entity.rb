...
class CouponEntity
  ...
  # @return [Coupon, Hash] the current Coupon data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Coupon fields)
  def match_get
  ...
  #
  # @param reqmatch [CouponListMatch, Hash, nil] match filter (any subset of
  #   Coupon fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Coupon>, Array] the matching Coupon items; raises MockError on failure
