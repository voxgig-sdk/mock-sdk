...
class GetCustomResourceEntity
  ...
  def make
    opts = @_entopts.dup
    GetCustomResourceEntity.new(@_client, opts)
  end
  ...
  # @return [GetCustomResource, Hash] the current GetCustomResource data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetCustomResource fields)
  def match_get
  ...
  #
  # @param reqmatch [GetCustomResourceListMatch, Hash, nil] match filter (any subset of
  #   GetCustomResource fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GetCustomResource>, Array] the matching GetCustomResource items; raises MockError on failure
