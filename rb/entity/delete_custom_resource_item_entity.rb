...
class DeleteCustomResourceItemEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "delete_custom_resource_item"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    DeleteCustomResourceItemEntity.new(@_client, opts)
  end
  ...
  # @return [DeleteCustomResourceItem, Hash] the current DeleteCustomResourceItem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DeleteCustomResourceItem fields)
  def match_get
