...
class CreateCustomResourceItemEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "create_custom_resource_item"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    CreateCustomResourceItemEntity.new(@_client, opts)
  end
  ...
  # @return [CreateCustomResourceItem, Hash] the current CreateCustomResourceItem data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CreateCustomResourceItem fields)
  def match_get
  ...
  #
  # @param reqdata [CreateCustomResourceItemCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CreateCustomResourceItem, Hash] the created CreateCustomResourceItem; raises MockError on failure
