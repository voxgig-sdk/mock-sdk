...
module MockTestRunner
  ...
  def self.env_override(m)
    live = getenv("MOCK_TEST_LIVE")
    override = getenv("MOCK_TEST_OVERRIDE")
    ...
    explain = getenv("MOCK_TEST_EXPLAIN")
    m["MOCK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
