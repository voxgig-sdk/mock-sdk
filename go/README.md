...
| `UpdateCustomResourceItem` | `(data map[string]any) MockEntity` | Create a UpdateCustomResourceItem entity instance. |
| `User` | `(data map[string]any) MockEntity` | Create a User entity instance. |
