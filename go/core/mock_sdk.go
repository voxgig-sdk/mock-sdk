...
func (sdk *MockSDK) OptionsMap() map[string]any {
...
func (sdk *MockSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MockSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MockSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MockSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MockSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MockSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MockSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MockSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MockSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MockSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
