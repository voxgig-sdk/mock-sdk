...
const testSeed = `map[string]any{"entity": map[string]any{"cart": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "coupon": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_custom_resource_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "delete_custom_resource_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_custom_resource": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_custom_resource_item_by_id": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "patch_custom_resource_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_custom_resource_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
