...
type PatchCustomResourceItemEntity struct {
	name    string
	client  *core.MockSDK
...
func NewPatchCustomResourceItemEntity(client *core.MockSDK, entopts map[string]any) *PatchCustomResourceItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &PatchCustomResourceItemEntity{
...
func (e *PatchCustomResourceItemEntity) GetName() string { return e.name }
...
func (e *PatchCustomResourceItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PatchCustomResourceItemEntity) Deleted() bool {
	return e.deleted
}


func (e *PatchCustomResourceItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPatchCustomResourceItemEntity(e.client, opts)
}

func (e *PatchCustomResourceItemEntity) Data(args ...any) any {
...
func (e *PatchCustomResourceItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PatchCustomResourceItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PatchCustomResourceItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PatchCustomResourceItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *PatchCustomResourceItemEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *PatchCustomResourceItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PatchCustomResourceItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
