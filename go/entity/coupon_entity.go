...
func NewCouponEntity(client *core.MockSDK, entopts map[string]any) *CouponEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CouponEntity) GetName() string { return e.name }
...
func (e *CouponEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CouponEntity) Deleted() bool {
	return e.deleted
}


func (e *CouponEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCouponEntity(e.client, opts)
}

func (e *CouponEntity) Data(args ...any) any {
...
func (e *CouponEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Coupon; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CouponEntity) DataTyped(data ...Coupon) Coupon {
	if len(data) > 0 {
		return typedFrom[Coupon](e.Data(asMap(data[0])))
	}
	return typedFrom[Coupon](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Coupon (all fields
// optional at the wire level).
func (e *CouponEntity) MatchTyped(match ...Coupon) Coupon {
	if len(match) > 0 {
		return typedFrom[Coupon](e.Match(asMap(match[0])))
	}
	return typedFrom[Coupon](e.Match())
}
...
func (e *CouponEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CouponEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CouponEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CouponListMatch and returns []Coupon. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CouponEntity) ListTyped(reqmatch CouponListMatch, ctrl map[string]any) ([]Coupon, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Coupon](res), nil
}



func (e *CouponEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CouponEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CouponEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CouponEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
