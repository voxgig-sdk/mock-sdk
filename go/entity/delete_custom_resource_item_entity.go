...
type DeleteCustomResourceItemEntity struct {
	name    string
	client  *core.MockSDK
...
func NewDeleteCustomResourceItemEntity(client *core.MockSDK, entopts map[string]any) *DeleteCustomResourceItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &DeleteCustomResourceItemEntity{
...
func (e *DeleteCustomResourceItemEntity) GetName() string { return e.name }
...
func (e *DeleteCustomResourceItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeleteCustomResourceItemEntity) Deleted() bool {
	return e.deleted
}


func (e *DeleteCustomResourceItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeleteCustomResourceItemEntity(e.client, opts)
}

func (e *DeleteCustomResourceItemEntity) Data(args ...any) any {
...
func (e *DeleteCustomResourceItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DeleteCustomResourceItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeleteCustomResourceItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeleteCustomResourceItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeleteCustomResourceItemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeleteCustomResourceItemEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DeleteCustomResourceItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
