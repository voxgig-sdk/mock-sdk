...
type UpdateCustomResourceItemEntity struct {
	name    string
	client  *core.MockSDK
...
func NewUpdateCustomResourceItemEntity(client *core.MockSDK, entopts map[string]any) *UpdateCustomResourceItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &UpdateCustomResourceItemEntity{
...
func (e *UpdateCustomResourceItemEntity) GetName() string { return e.name }
...
func (e *UpdateCustomResourceItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpdateCustomResourceItemEntity) Deleted() bool {
	return e.deleted
}


func (e *UpdateCustomResourceItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUpdateCustomResourceItemEntity(e.client, opts)
}

func (e *UpdateCustomResourceItemEntity) Data(args ...any) any {
...
func (e *UpdateCustomResourceItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *UpdateCustomResourceItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UpdateCustomResourceItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UpdateCustomResourceItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *UpdateCustomResourceItemEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *UpdateCustomResourceItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UpdateCustomResourceItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
