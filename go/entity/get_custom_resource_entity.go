...
type GetCustomResourceEntity struct {
	name    string
	client  *core.MockSDK
...
func NewGetCustomResourceEntity(client *core.MockSDK, entopts map[string]any) *GetCustomResourceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetCustomResourceEntity) GetName() string { return e.name }
...
func (e *GetCustomResourceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetCustomResourceEntity) Deleted() bool {
	return e.deleted
}


func (e *GetCustomResourceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetCustomResourceEntity(e.client, opts)
}

func (e *GetCustomResourceEntity) Data(args ...any) any {
...
func (e *GetCustomResourceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetCustomResource; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetCustomResourceEntity) DataTyped(data ...GetCustomResource) GetCustomResource {
	if len(data) > 0 {
		return typedFrom[GetCustomResource](e.Data(asMap(data[0])))
	}
	return typedFrom[GetCustomResource](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetCustomResource (all fields
// optional at the wire level).
func (e *GetCustomResourceEntity) MatchTyped(match ...GetCustomResource) GetCustomResource {
	if len(match) > 0 {
		return typedFrom[GetCustomResource](e.Match(asMap(match[0])))
	}
	return typedFrom[GetCustomResource](e.Match())
}
...
func (e *GetCustomResourceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetCustomResourceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetCustomResourceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetCustomResourceListMatch and returns []GetCustomResource. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetCustomResourceEntity) ListTyped(reqmatch GetCustomResourceListMatch, ctrl map[string]any) ([]GetCustomResource, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetCustomResource](res), nil
}



func (e *GetCustomResourceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetCustomResourceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetCustomResourceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetCustomResourceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
