...
func NewCartEntity(client *core.MockSDK, entopts map[string]any) *CartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CartEntity) GetName() string { return e.name }
...
func (e *CartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CartEntity) Deleted() bool {
	return e.deleted
}


func (e *CartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCartEntity(e.client, opts)
}

func (e *CartEntity) Data(args ...any) any {
...
func (e *CartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cart; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CartEntity) DataTyped(data ...Cart) Cart {
	if len(data) > 0 {
		return typedFrom[Cart](e.Data(asMap(data[0])))
	}
	return typedFrom[Cart](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cart (all fields
// optional at the wire level).
func (e *CartEntity) MatchTyped(match ...Cart) Cart {
	if len(match) > 0 {
		return typedFrom[Cart](e.Match(asMap(match[0])))
	}
	return typedFrom[Cart](e.Match())
}
...
func (e *CartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CartEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CartEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CartListMatch and returns []Cart. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CartEntity) ListTyped(reqmatch CartListMatch, ctrl map[string]any) ([]Cart, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cart](res), nil
}



func (e *CartEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CartEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
