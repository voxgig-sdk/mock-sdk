...
**Entities** (11): `Cart`, `Coupon`, `CreateCustomResourceItem`, `DeleteCustomResourceItem`, `GetCustomResource`, `GetCustomResourceItemById`, `PatchCustomResourceItem`, `Product`, `Status`, `UpdateCustomResourceItem`, `User`.
